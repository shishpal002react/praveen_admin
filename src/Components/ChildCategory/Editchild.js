            ...
            <Modal.Body>
                <Form>
                    <Form.Group className="popUpFrom" style={{ marginTop: "20px" }}>
                        ...
                        <Form.Control as="select" onChange={(e) => setParentcat(e.target.value)}>
                            {
                                data && data.map((item) => (
                    ...
                    <Form.Group style={{ marginTop: "20px" }}>
                        ...
                        <Form.Control type="text" placeholder="Child Category" value={childcat} onChange={(e) => setChildcat(e.target.value)} />
                    </Form.Group>
                    <Form.Group style={{ marginTop: "20px" }}>
